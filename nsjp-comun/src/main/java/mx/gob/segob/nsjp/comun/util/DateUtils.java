/**
 * Nombre del Programa : DateUtils.java Autor : vaguirre Compania : Ultrasist
 * Proyecto : NSJP Fecha: 18 Apr 2011 Marca de cambio : N/A Descripcion General
 * : Clase de utileria de fechas. Programa Dependiente :N/A Programa Subsecuente
...
public class DateUtils {
    ...
    private final static SimpleDateFormat SDF_FECHA_SQL_105 = new SimpleDateFormat("dd-MM-yyyy");
     ...
     *
     * @param fechaStr Fecha en <code>String</code> a transformar en formato
     * <b>dd/MM/yyyy</b>.
     * @return
     * @throws NSJPNegocioException En caso de que la cadena no tenga el formato
     * esperado.
     */
     ...
     * @param fechaStr Fecha en <code>String</code> a transformar en formato
     * <b>dd/MM/yyyy</b>.
     * @param horaStr Hora en <code>String</code> a transformar en formato
     * <b>HH:mm</b>.
     * @return
     * @throws NSJPNegocioException En caso de que la cadena no tenga el formato
     * esperado.
     ...
     * @param horaStr Hora en <code>String</code> a transformar en formato
     * <b>HH:mm</b>.
     * @return La fecha con el a&ntilde;os, mes d&iacute;a, hora y minuto
     * especificado. Si alguna de las cadenas es apunta a <code>null</code>
    ...
    /**
     * Obtiene la hora en una representaci&oacute;n <code>String</code> con el
     * formato
     * <b>HH:mm</b>.
     *
    ...
    /**
     * Obtiene la fecha en una representaci&oacute;n <code>String</code> con el
     * formato
     * <b>dd/MM/yyyy</b>.
     *
     * @param date Fecha a transformar.
     ...
     * el <i>style</i> <b>112</b>, ejempo:      <code>CONVERT (nvarchar, obj.fechaAtencion, 112) =
     * ?</code> .
     *
     * @param date Fecha a transformar.
     * @return Fecha en <code>String</code>.
     ...
     *
     * @param fecha Instancia de calendario
     */
    ...
    /**
     * Asigna la fecha en hora, minuto, segundo y milisegundo en 0. Para obtener
     * solo la fecha.
     *
     * @param fecha
     */
    ...
    /**
     * Suma un determinado numero de d&iacute;as a una fecha. Se respeta la
     * congruencia de la fecha.
     *
     * @param fecha
     * @param dias
     */
     ...
     * Obtiene la fecha en una representaci&oacute;n <code>String</code> con el
     * formato
     * <b>YYYY-MM-DD HH:MI:SS</b> para usarse con el <code>CONVERT</code> de sql
     * Server con el <i>style</i> <b>131/b>, ejempo:      <code>CONVERT (nvarchar, obj.fechaAtencion, 131) =
     * ?</code> .
     *
     * @param date Fecha a transformar.
     * @return Fecha en <code>String</code>.
    ...
    /**
     * M&eacute;todo utilitario que se utiliza para calcular el intervalo de
     * a&ntilde;os que ha transcurrido entre dos fechas.
     *
     * @param fechaInicial - Fecha inicial de la cual se va a calcular los
     * a&ntilde;os transcurridos.
     * @param fechaFinal - Fecha final de la cual se va a calcular los
     * a&ntilde;os transcurridos.
    ...
    /**
     * M&eacute;todo utilitario que se utiliza para calcular el intervalo de
     * meses que ha transcurrido entre dos fechas.
     *
     * @param fechaInicial - Fecha inicial de la cual se va a calcular los meses
     * transcurridos.
     * @param fechaFinal - Fecha final de la cual se va a calcular los meses
     * transcurridos.
    ...
    /**
     * M&eacute;todo utilitario que se utiliza para calcular el intervalo de
     * d&iacute;as que ha transcurrido entre dos fechas.
     *
     * @param fechaInicial - Fecha inicial de la cual se va a calcular los
    ...
    /**
     * M&eacute;todo que lleva a cabo la suma de una fecha y un intervalo de
     * tiempo transcurrido.
     *
     * @param fechaOriginal - fecha inicial a la cual se va a sumar el intervalo
     ...
     * @return fechaCalculada - <code>Date</code> con la fecha calculada una vez
     * que se ha sumado el intervalo de tiempo transcurrido.
     */
    ...
    /**
     * M&eacute;todo que lleva a cabo la resta de una fecha y un intervalo de
     * tiempo transcurrido.
     *
     * @param fechaOriginal - fecha inicial a la cual se va a restar el
     ...
     * @return fechaCalculada - <code>Date</code> con la fecha calculada una vez
     * que se ha restado el intervalo de tiempo transcurrido.
     */
