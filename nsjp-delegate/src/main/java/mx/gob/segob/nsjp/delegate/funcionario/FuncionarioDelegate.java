...
public interface FuncionarioDelegate {
     ...
     * del perito que se le pasa como par&acute;metro o la lista vac&iacute;a en caso de
    ...
    /**
     * Operaci&oacute;n que realiza la funcionalidad de asociar el Perito seleccionado
     * con el n&uacute;mero de expediente
     * Recibe el perito y el n&uacute;mero de expediente
     * @param peritoDto
     * @param expediente
     * @throws NSJPNegocioException
     */
     ...
     * 				  ser&aacute; registrado para el funcionario, los aributos obligatorios son 
     * 				  <code>fechaInicioEvento</code> Fecha en que inicia el per&iacute;odo
     * 				  <code>fechaFinEvento</code> Fecha en que termina el per&iacute;odo
     * 				  <code>tipoEvento</code> Tipo de Evento que registra el per&iacute;odo Vacaiones o Incapacidad
     *  			  <code>nombreEvento</code> Nombre del per&iacute;odo
    ...
    /**
	 * Operaci&oacute;n que realiza la funcionalidad de obtener del conjunto de defensores de un 
	 * tipo de Defensa, aquellos que tiene los valores de carga de trabajo m&aacute;s baja o menor.
	 * 
	...
	/**
	 * Operaci&oacute;n que realiza la funcionalidad de seleccionar de un conjunto de elementos, uno aleatoriamente.
	 * 
	 ...
	 * @param area identificador del &aacute;rea de la cual se obtendr&aacute;n los funcionarios
	 ...
	 * Requiere como parametro el Id del Rol, extraido de la enumeraci&oacute;n de Roles.
	 * @param idRol
	 * @return
	 * @throws NSJPNegocioException
	 */
	...
	/**
	 * Operaci&oacute;n que realiza la funcionalidad de consultar el personal o los funcionarios adscritos a un departamento de la Instituci&oacute;n.
     ...
     * @param usuario
     * 			Rol activo del usuario,discriminante y catUIE si es necesario
	 ...
	 * 												  cabo la consulta.
	 * @param target - La instituci&oacute;n sobre la cual se va a invocar el servicio.
	 * @return List<FuncionarioDTO> - Lista de funcionarios que cumplen con el criterio 
	 * 		   						  de b&uacute;squeda. 
	 * @throws NSJPNegocioException
	 */
