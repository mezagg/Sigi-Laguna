/**
 * Nombre del Programa : AudienciaJAVSTransporteDTO.java
 * Autor                            : AAAV
 * Compania                    : Ultrasist
 ...
 * 
 */
public class AudienciaJAVSTransporteDTO extends GenericWSDTO {

	private static final long serialVersionUID = 3135680302829779242L;
	String registroMaestroJVL;
	String directoriosServidorJAVS;
	byte[] bytesRegistroMaestroJVL;			// JVL
	byte[] bytesDirectoriosServidorJAVS;	// Paths
	String usuarioJAVS; 					// Usuario
	String passwordJAVS;					// Password
	String dirIPJAVS;						// DirIP
	Long resultadoPermisoAudiencia;
	Long audiencia;							// audiencia
