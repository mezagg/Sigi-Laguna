...
public interface ConfActividadDocumentoDAO extends
    ...
    /**
     * Permite consultar el proximo valor del estatus de un numero de expediente en base a su tipo de actividad, asi como 
     * al numero de expediente actual y la jerarquía a la cual pertenece el documento
