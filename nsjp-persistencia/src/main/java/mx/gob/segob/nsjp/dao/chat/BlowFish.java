...
/* Primera clase encriptadora ke no funciona bien
...
public class BlowFish {
    ...
    public static void main(String[] args) {
		BlowFish blowFish=new BlowFish("1lw5G2t4I97F02v");
		Log.debug("adin encript:"+blowFish.encryptString("admin"));
		Log.debug(blowFish.decryptString("b7b77c43fcf66a3989e1b296a9efbf61d8a65adb3ca32310"));
	}
}
