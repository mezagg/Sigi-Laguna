...
public interface ExpedienteDAO extends GenericDao<Expediente, Long> {
	 ...
	 *  - Canalizados a Unidad de investigaci�n
	 *  FACILITADOR
	 *  - Bandeja principal
	 *  - Por unidad de investigaci�n
	 *  - Por atenci�n temprana penal
	 *  COORDINADOR AMP
	 *  - BANDEJA PRINCIPAL
	 *  - Sin asignar
	 *  - Asignados
	...
	/**
	 * Consulta la informaci�n relacionada a un expediente
	 ...
	 * con una solicitud de l&iacute;nea de investigaci&oacute;n pero a�n no tienen un expediente en Polic�a Ministerial.  
	 * @param filtroExpedienteDTO
	 * @return
	 */
