...
public interface FuncionarioDAO extends GenericDao<Funcionario, Long> {
	...
	/**
	 * Servicio que consulta los Funcionarios por ROl, para la versión multi Rol.
	 * 
	 * @param idRol
	 * @return
	 */
	...
	(Date fecha,Integer duracionEstimada,Boolean paridadJuezRequerida, Funcionario funcionario) throws NSJPNegocioException;
	...
	/**
	 * Permite consultar a los funcionarios por rol y otros criterios como nombre
	 * puesto, discriminante, numero de empleado, etc.
	 * @param filtro
	 * @param idRol
    ...
    /**
     * Operación que realiza la funcionalidad de asociar el Perito
     * seleccionado con el número de expediente
     * Recibe el perito y el número de expediente
	...
	/**
	 * Obtiene los funcionarios subordinados de otro funcionario, por medio 
	 * de los roles subordinados, el distrito, y de ser necesario la
    ...
    /**
     * Consulta la disponibilidad de un funcionario para la fecha señalada por time
	...
	public List<Funcionario> consultarFuncionariosXCriterio(CriterioConsultaFuncionarioExternoDTO 
			criterioConsultaFuncionarioExternoDTO, Funcionario funcionario) throws NSJPNegocioException;
