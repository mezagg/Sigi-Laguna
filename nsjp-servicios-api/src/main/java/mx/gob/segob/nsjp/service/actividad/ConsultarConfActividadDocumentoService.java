/**
 * Nombre del Programa : ConsultarConfActividadDocumentoService.java Autor :
...
public interface ConsultarConfActividadDocumentoService {
     ...
     * categor&iacute;a a la que pertenece dicha actividad, que se le pasa como
     * parametro.<br/>
     * Los campos requeridos son: {@code usuario.IdUsuario} y {@code
     * expediente.numeroExpediente}, opcionalmente el usuario deberia venir
     * asociado con su funcionario pero si esto no ocurre el sistema lo consulta
     * automaticamente.
     *
     ...
     * estatus.
     * @param idCategoriaActividad El identificador de la Categor&iacute;a de
     * Actividada con la cual se hace un filtro en la busqueda.
     * @return Los registros de la base que contienen los tipo de actividades y
     * tipos de documentos configurados en el sistema para el usuario y numero
     * de expediente dados. Regresa la lista vacia en caso de no existir
     * registros en la base asociados a los parametros de consulta.
    ...
    /**
     * Consulta todas las actividades asociadas al expediente (opcional) y de
     * acuerdo al tipo de Actividad (opcional), se considera si se considera el
     * documento generado o solo la actividad generada.
     *
     * @param idExpediente
     ...
     *
     * @param filtro - <code>ConfTipoActividadOrigenDestinoDTO</code> con los
     * filtros sobre los cuales se va a llevar a cabo la consulta de la
     * actuaci&oacute;n de respuesta.
     * @return ConfActividadDocumentoDTO - Objeto con la informaci&oacute;n de
     * la actuaci&oacute;n de respuesta que corresponde con los datos ingresados
     * como filtros.
     * @throws NSJPNegocioException - En el caso de que la consulta de la
     * actuaci&oacute;n no se haya podido llevar a cabo.
     */
     ...
     *
     * @param filtro - ConfActividadDocumentoDTO con la informaci&oacute;n de la
     ...
     * @throws NSJPNegocioException - En el caso de que el filtro no cuente con
     * el id del tipo de actividad a consultar.
     */
     ...
     *
     * @param filtroConfActividadDocumentoDTO - Objeto de tipo
     * ConfActividadDocumentoDTO ingresado como par&aacute;metro.
     * @return List<ConfActividadDocumentoDTO> - List<ConfActividadDocumentoDTO>
     * que cumplen con los criterios ingresados dentro del filtro.
     * @throws NSJPNegocioException - En el caso de que no se haya podido llevar
     * a cabo la consulta de manera correcta.
     */
