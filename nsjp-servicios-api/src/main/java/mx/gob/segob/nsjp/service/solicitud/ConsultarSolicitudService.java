...
public interface ConsultarSolicitudService {
	 ...
	 * Se agrega nueva funcionalidad para las solcitudes de Defensoria (Solicitud de Defensor
	 * y Solicitud de Asesoria Legal), el filtro se encuntra en el atributo de la SolicitudDTO
	 * con el nombre de AvisoDesignacion
	 * 
	 * @param SolicitudDTO solFiltro (Setear los valores que se aplicar&aacute;n en el filtro)
	...
	/**
	 * Permite consultar solicitudes asociadas a Numeros de expedeintes y tipos de solicitud
	 * @param idCaso
	 * @param idTipoSolicitud
	 * @return
	 * @throws NSJPNegocioException
