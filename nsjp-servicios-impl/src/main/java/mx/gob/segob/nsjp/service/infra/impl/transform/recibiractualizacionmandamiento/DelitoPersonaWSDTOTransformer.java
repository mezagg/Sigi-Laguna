...
public class DelitoPersonaWSDTOTransformer {
	...
	public static mx.gob.segob.nsjp.ws.cliente.recibiractualizacionmandamiento.DelitoPersonaWSDTO transformar(
		...
		mx.gob.segob.nsjp.ws.cliente.recibiractualizacionmandamiento.DelitoPersonaWSDTO delitoPersonaWSDTO = new mx.gob.segob.nsjp.ws.cliente.recibiractualizacionmandamiento.DelitoPersonaWSDTO();
	...
	public static List<mx.gob.segob.nsjp.ws.cliente.recibiractualizacionmandamiento.DelitoPersonaWSDTO> transformarListaDTOaWSDTO(
		...
		List<mx.gob.segob.nsjp.ws.cliente.recibiractualizacionmandamiento.DelitoPersonaWSDTO> delitosPersonaWSDTO = new ArrayList<mx.gob.segob.nsjp.ws.cliente.recibiractualizacionmandamiento.DelitoPersonaWSDTO>();
