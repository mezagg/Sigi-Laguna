 ...
 * Marca de cambio			: N/A
 * Descripcion General		: MandamientoPersonaWSDTOTransformer
...
public class MandamientoPersonaWSDTOTransformer {
	...
	public static mx.gob.segob.nsjp.ws.cliente.recibiractualizacionmandamiento.MandamientoPersonaWSDTO transformar(
		...
		mx.gob.segob.nsjp.ws.cliente.recibiractualizacionmandamiento.MandamientoPersonaWSDTO mandamientoPersonaWSDTO = new mx.gob.segob.nsjp.ws.cliente.recibiractualizacionmandamiento.MandamientoPersonaWSDTO();
		...
		if (mandamientoPersonaDTO.getPersona() != null
			...
			mx.gob.segob.nsjp.ws.cliente.recibiractualizacionmandamiento.PersonaWSDTO personaWSDTO = new mx.gob.segob.nsjp.ws.cliente.recibiractualizacionmandamiento.PersonaWSDTO();
	...
	public static List<mx.gob.segob.nsjp.ws.cliente.recibiractualizacionmandamiento.MandamientoPersonaWSDTO> transformarListaDTOaWSDTO(
		...
		List<mx.gob.segob.nsjp.ws.cliente.recibiractualizacionmandamiento.MandamientoPersonaWSDTO> mandamientosPersonaWSDTO = new ArrayList<mx.gob.segob.nsjp.ws.cliente.recibiractualizacionmandamiento.MandamientoPersonaWSDTO>();
