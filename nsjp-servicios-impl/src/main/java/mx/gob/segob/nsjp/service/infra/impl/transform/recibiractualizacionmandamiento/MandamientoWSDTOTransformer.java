...
public class MandamientoWSDTOTransformer {
	...
	public static MandamientoDTO Transformar(MandamientoWSDTO mandamientoWSDTO) {
		...
		if (mandamientoWSDTO.getMandamientosPersona() != null
				&& !mandamientoWSDTO.getMandamientosPersona().isEmpty()) {
			mandamientoDTO
	...
	public static mx.gob.segob.nsjp.ws.cliente.recibiractualizacionmandamiento.MandamientoWSDTO Transformar(
			MandamientoDTO mandamientoDTO) {

		mx.gob.segob.nsjp.ws.cliente.recibiractualizacionmandamiento.MandamientoWSDTO mandamientoWSDTO = null;
		...
		mandamientoWSDTO = (mx.gob.segob.nsjp.ws.cliente.recibiractualizacionmandamiento.MandamientoWSDTO) DocumentoWSDTOTransformer
