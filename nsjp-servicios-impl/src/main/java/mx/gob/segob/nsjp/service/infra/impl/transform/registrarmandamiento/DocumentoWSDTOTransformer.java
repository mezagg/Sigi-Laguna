...
public class DocumentoWSDTOTransformer {
	...
	public static DocumentoDTO transformar(
			mx.gob.segob.nsjp.dto.documento.DocumentoWSDTO src) {
	...
	public static mx.gob.segob.nsjp.ws.cliente.mandamiento.DocumentoWSDTO transformar(
			DocumentoDTO src) {

		mx.gob.segob.nsjp.ws.cliente.mandamiento.DocumentoWSDTO documentoWSDTO = null;
		...
		if (src instanceof MandamientoDTO) {
			documentoWSDTO = new mx.gob.segob.nsjp.ws.cliente.mandamiento.MandamientoWSDTO();
		} else {
			documentoWSDTO = new mx.gob.segob.nsjp.ws.cliente.mandamiento.DocumentoWSDTO();
		}
		...
		if (src.getArchivoDigital() != null) {
			...
			mx.gob.segob.nsjp.ws.cliente.mandamiento.ArchivoDigitalWSDTO archivoDigitalWSDTO = new mx.gob.segob.nsjp.ws.cliente.mandamiento.ArchivoDigitalWSDTO();
