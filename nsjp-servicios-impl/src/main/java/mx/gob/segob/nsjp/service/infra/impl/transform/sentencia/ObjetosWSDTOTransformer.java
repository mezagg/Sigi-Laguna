 ...
 * Marca de cambio        : N/A
 * Descripcion General    : Clase de transformaci�n para los Objetos asociados al expediente.
...
import mx.gob.segob.nsjp.ws.cliente.sentencia.AeronaveWSDTO;
import mx.gob.segob.nsjp.ws.cliente.sentencia.AnimalWSDTO;
import mx.gob.segob.nsjp.ws.cliente.sentencia.ArchivoDigitalWSDTO;
import mx.gob.segob.nsjp.ws.cliente.sentencia.ArmaWSDTO;
import mx.gob.segob.nsjp.ws.cliente.sentencia.CadenaDeCustodiaWSDTO;
import mx.gob.segob.nsjp.ws.cliente.sentencia.CalidadWSDTO;
import mx.gob.segob.nsjp.ws.cliente.sentencia.DocumentoOficialWSDTO;
import mx.gob.segob.nsjp.ws.cliente.sentencia.DocumentoWSDTO;
import mx.gob.segob.nsjp.ws.cliente.sentencia.EmbarcacionWSDTO;
import mx.gob.segob.nsjp.ws.cliente.sentencia.EquipoComputoWSDTO;
import mx.gob.segob.nsjp.ws.cliente.sentencia.EslabonWSDTO;
import mx.gob.segob.nsjp.ws.cliente.sentencia.EvidenciaWSDTO;
import mx.gob.segob.nsjp.ws.cliente.sentencia.ExplosivoWSDTO;
import mx.gob.segob.nsjp.ws.cliente.sentencia.JoyaWSDTO;
import mx.gob.segob.nsjp.ws.cliente.sentencia.NumerarioWSDTO;
import mx.gob.segob.nsjp.ws.cliente.sentencia.ObjetoWSDTO;
import mx.gob.segob.nsjp.ws.cliente.sentencia.ObraArteWSDTO;
import mx.gob.segob.nsjp.ws.cliente.sentencia.SustanciaWSDTO;
import mx.gob.segob.nsjp.ws.cliente.sentencia.TelefoniaWSDTO;
import mx.gob.segob.nsjp.ws.cliente.sentencia.VegetalWSDTO;
import mx.gob.segob.nsjp.ws.cliente.sentencia.VehiculoWSDTO;

import org.apache.log4j.Logger;

/**
 * Clase de transformaci�n para los Objetos asociados al expediente.
 * Transforma de un Objeto WSDTO a un Objeto DTO y viceversa.
 * 
 * @author GustavoBP
 * @version 1.0
