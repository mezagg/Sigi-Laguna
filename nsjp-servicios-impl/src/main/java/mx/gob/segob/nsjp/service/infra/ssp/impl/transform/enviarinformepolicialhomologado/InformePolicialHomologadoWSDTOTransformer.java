...
*------------------------------------------------------------------------------
*/
package mx.gob.segob.nsjp.service.infra.ssp.impl.transform.enviarinformepolicialhomologado;
...
public class InformePolicialHomologadoWSDTOTransformer {
	...
	public static InformePolicialHomologadoDTO transformarWSDTO(mx.gob.segob.nsjp.dto.ssp.informepolicial.InformePolicialHomologadoWSDTO iphWSDTO){
