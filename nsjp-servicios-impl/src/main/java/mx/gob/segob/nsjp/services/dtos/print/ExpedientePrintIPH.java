/**
* Nombre del Programa : ExpedientePrintIPH.java
* Autor                            : GustavoBP
* Compania                    : Ultrasist
 ...
 *
 */
public class ExpedientePrintIPH {

	//TODO GBP Cambiar a infra.... hacer uso de "IMPRIMIR OBJETO DINAMICO" Basarse en Expediente.transform
	private final static Logger logger = Logger.getLogger(ExpedientePrintIPH.class);
	...
	public static void imprimirDatosExpediente(ExpedienteWSDTO expedienteWSDTO ){
		...
		logger.info("Hecho " + expedienteWSDTO.getHechoDTO());
		if (expedienteWSDTO.getHechoDTO() != null) {
			HechoWSDTO hechoWSDTO =expedienteWSDTO.getHechoDTO() ; 
			logger.info("Hecho - DescNarrativa: "+ hechoWSDTO.getDescNarrativa());
			logger.info("Hecho - Lugar: "+ hechoWSDTO.getLugar());
			if (hechoWSDTO.getLugar()instanceof LugarWSDTO ){
				DomicilioWSDTO domicilioWSDTO = (DomicilioWSDTO) hechoWSDTO.getLugar();
		...
		if (expedienteWSDTO.getHechoDTO() != null) {			
			if (expedienteWSDTO.getHechoDTO().getLugar() != null)
				logger.info("Lugar Hecho id : "
						+ expedienteWSDTO.getHechoDTO().getLugar());
		}
...
//			}
		...
		if( expedienteWSDTO.getInvolucradosDTO()!= null && !expedienteWSDTO.getInvolucradosDTO().isEmpty()){
			...
			for (InvolucradoWSDTO involucradoWSDTO : lInvolucradoWSDTO) {
				...
				InvolucradoPrintIPH.imprimirDatosInvolucrado(involucradoWSDTO);
			}
		}
