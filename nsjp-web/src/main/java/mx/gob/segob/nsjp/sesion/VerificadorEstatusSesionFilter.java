 ...
 * redireccionarlo a la p�gina de cambio de contrasenia.
 * 
 * @author IgnacioFO
 * 
 */
public class VerificadorEstatusSesionFilter implements Filter {
	...
	/**
	 * M�todo que maneja el caso de que la sesion es existente.
	 * 
	...
	private void manejarSesionExistente(ServletRequest servletRequest,
		...
		if (usuarioDTO != null && usuarioDTO.getIdUsuario() != null) {
			//		 Inicia parte de autorizador de navegaci�n - LOMG
			...
			// Fin parte de autorizador de navegaci�n - LOMG
