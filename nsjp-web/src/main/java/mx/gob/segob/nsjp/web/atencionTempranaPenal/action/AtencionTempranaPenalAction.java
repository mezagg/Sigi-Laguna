...
//				}
	...
	/**
	 * M&eacute;todo para enviar los avisos de detencion de los probables responsables
...
//				usuarioDTO.setAreaActual(new AreaDTO(Areas.ATENCION_TEMPRANA_PG));
	...
	/**
	 * M&eacute;todo utilizado para realizar la carga del combo de
	 * actuaciones teniendo en cuenta los par&aacute;metros de filtrado
	 * de la actividad.
	 * 
	 * @param mapping - mapeo de struts para enlazar las peticiones.
	 * @param form - Forma de struts con la informaci&oacute;n capturada
	 * 				 en la vista. 
	 * @param request - Objeto de java que representa la petici&oacute;n
	 * 					de HTML.
	 * @param response - Objeto de java que representa la respuesta de 
	 * 					 HTML.
	 ...
	 * 						 excepci&oacute;n al momento de escribir la 
	 * 						 respuesta.
	 */
	...
	/**
	 * M&eacute;todo que lleva a cabo la consulta de los delitos persona que se encuentran
	 * asociados a un mandamiento y regresa la información correspondiente dentro de un 
	 * xml.
	 *  
	 * @param mapping - mapeos de struts para encadenar las peticiones.
	 * @param form - Forma de struts en donde viaja la informaci&oacute;n capturada desde la
	 * 				 vista.
	 ...
	 * @return null - Se regresa null, ya que la respuesta se regresa dentro de la respuesta 
	 * 				  de HTML en un xml.
	...
	/**
	 * M&eacute;todo que lleva a cabo el registro de una solicitudMandamiento a partir
	 * de una Solicitud y un Mandamiento Judicial previamente existente.
	 *  
	 * @param mapping - mapeos de struts para encadenar las peticiones.
	 * @param form - Forma de struts en donde viaja la informaci&oacute;n capturada desde la
	 * 				 vista.
