...
public class SolicitudCiudadanaDefensorAction extends GenericAction {
	...
	/**
	 * Busqueda del siguiente turno a buscar de acuerdo al Tipo de Busqueda pasado desde vista. 
	 * Se considera el manejo de Distritos
	 * 
	 * @param mapping
	 * @param form
	 * @param request
	...
	/**
	 * Registro de la solicitud de Asesoria Legal. 
	 * Se crea el expediente, numero de expediente y la Solicitud. 
	 * No se considera la creacion de un caso, 
	 * No se considera la etapa del catalogo de etapas, se hace uso de las definidas
	 * en el enum de EtapasExpediente.java  
	 * 
	 * @param mapping
	 * @param form
	 * @param request
...
//			}
	...
	/**
	 * Action que actualiza el estatus de las solicitudes de acuerdo al numero de expediente 
	 * proporcionado, tambien cambia el estatus del numero de expediente. 
	 * 
	 * @param mapping
	 * @param form
	 * @param request
...
//			
	 ...
	 * estatus atendida de los avisos de detenci&oacute;n por estatus atendidos y
	...
	/**
	 * Genera un aviso de designaci&oacute;n al cual ser&aacute; asociado un abogado defensor posteriormente
	...
	/**
	 * M&eacute;todo utilizado para realizar la consulta de un centro de detencion por medio de su id
	 * @param mapping
	 * @param form
	 * @param request
	 * @param response
	...
	/**
	 * M&eacute;todo utilitario que lleva a cabo la generaci&oacute;n de cadenas de delitos omitiendo
	 * aquellos delitos que se encuentran repetidos dentro de la lista. 
	 * @param delitos - Lista con los delitos de la cual se va a generar la cadena.
	 * @return cadenaDelitos - Cadena con los nombres de los delitos concatenados evitando repeticiones.
	 */
	...
	/**
	 * M&eacute;todo para llevar a cabo la consulta de las solicitudes de defensor
	 * de acuerdo al estatus de loa solicitud y al la instituci&oacute;n
	 * solicitante
	 * 
	 * @param mapping
	 * @param form
...
//									: "---") + "</cell>");
	...
	/**
	 * M&eacute;todo para validar el estatus de la solicitud
	 * 1) Si la solicitud esta abierta solo debe preguntar por la confirmacion
	 * 2) Si la solicitud NO esta abierta,
	 * 	2.1) Verificar si el coordinador es el due&ntilde;o y de ser as&iacute; abre el visor
	 *  2.2) Si el usuario no es el due&ntilde;o, entonces pregunta si desea ver el detalle
	 * 3) En caso que no se encuentre la solicitud, env&iacute;a mensaje de error en vista
	 * @param mapping
	 * @param form
	 * @param request
	 * @param response
