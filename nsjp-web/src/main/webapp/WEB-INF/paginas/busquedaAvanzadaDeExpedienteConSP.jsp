...
<script type="text/javascript">
	...
	$(document).ready(function() {
		...
		$("#nombreOrg").bind("keyup blur" , function () {
			validarCampo(/[^a-zA-Z ·ÈÌÛ˙¡…Õ”⁄‰ÎÔˆ¸ƒÀœ÷‹—Ò&]/g , $(this).val()) == true ?
			$(this).removeClass("error") :  $(this).addClass("error");
		});	
						 			...
						 			if(idRolActivo != '<%=Roles.PERITOAMP.getValorId()%>'){
						 				...
						 				if(tipoOperacion == CONSULTAR_HISTORIAL_DE_EXPEDIENTE){
							 				...
							 				if(esConsulta == "1"){
												...
												customAlert("Usted no es el dueÒo del expediente,<br> y no cuenta con permisos para consultarlo.","");
											}	 
	...
	//FunciÛn que genera un nuevo n&uacute;mero de expediente para la UI en el mismo expediente
	...
	//Funcion que valida si los campos estan llenos al enviar 
		...
		function validaCamposDelaBusqueda(){
			...
			//Nombre Fun
			if(validarCampo(/[^a-zA-Z ·ÈÌÛ˙¡…Õ”⁄‰ÎÔˆ¸ƒÀœ÷‹—Ò]/g , $("#nombreFun").val()) == false)
				mensaje = mensaje + "<br /> - Nombre del funcionario"
			//Apellido paterno funcionario
			if(validarCampo(/[^a-zA-Z ·ÈÌÛ˙¡…Õ”⁄‰ÎÔˆ¸ƒÀœ÷‹—Ò]/g , $("#apellidoFun").val()) == false)
				mensaje = mensaje + "<br /> - Apellido paterno del funcionario"
			//Apellido Materno Funcionario
			if(validarCampo(/[^a-zA-Z ·ÈÌÛ˙¡…Õ”⁄‰ÎÔˆ¸ƒÀœ÷‹—Ò]/g , $("#apellidoMatFun").val()) == false)
				mensaje = mensaje + "<br /> - Apellido materno del funcionario"
				
				if($(':radio[name=RadioGroupTipoPersona]:checked').val() == 2){
					//Para la organizacion
					if(validarCampo(/[^a-zA-Z ·ÈÌÛ˙¡…Õ”⁄‰ÎÔˆ¸ƒÀœ÷‹—Ò&]/g , $("#nombreOrg").val()) == false)
					...
					//Nombre
					if(validarCampo(/[^a-zA-Z ·ÈÌÛ˙¡…Õ”⁄‰ÎÔˆ¸ƒÀœ÷‹—Ò]/g , $("#nombre").val()) == false)
						mensaje = mensaje + "<br /> - Nombre del involucrado"
					//Apellido paterno
					if(validarCampo(/[^a-zA-Z ·ÈÌÛ˙¡…Õ”⁄‰ÎÔˆ¸ƒÀœ÷‹—Ò]/g , $("#apellido").val()) == false)
						mensaje = mensaje + "<br /> - Apellido paterno del involucrado"
					//Apellido materno
					if(validarCampo(/[^a-zA-Z ·ÈÌÛ˙¡…Õ”⁄‰ÎÔˆ¸ƒÀœ÷‹—Ò]/g , $("#apellidoMat").val()) == false)
				...
				//Validar fecha de creaciÛn del expediente:inicio y fin
		...
		**/
		...
		/**
		* Permite consultar un expediente de atenciÛn temprana administrativa
		**/
