	...
	var documentoParcialGuardado="";
		...
		*/
		...
		function respuestaAlEnviar(){
			alertDinamicoCerrar("El documento se envi&oacute; de manera correcta");			
		}
		...
		<tr>			
			...
			<td width="800px" valign="top" align="center">
				...
				<form name="frmDoc" action="<%= request.getContextPath() %>/GenerarDocumentoNotificacion.do" method="post">
					...
					<input type="hidden" name="variosExpedientes" value="<%=request.getParameter("variosExpedientes")!=null?request.getParameter("variosExpedientes"):"" %>"/>
				</form>				
			</td>
		</tr>
	</table>
