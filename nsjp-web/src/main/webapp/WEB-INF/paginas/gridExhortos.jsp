...
<%@page import="mx.gob.segob.nsjp.dto.exhorto.ExhortoDTO"%>
...
<!--para creacion de arboles-->
	...
	$(document).ready(function() {
		...
		*/
		jQuery("#gridExhortosPJJU").jqGrid({ 
			url:'<%= request.getContextPath()%>/detalleExhortosPJENS.do',
			data: 'idExpediente='+ 1,
			datatype: "xml", 
			colNames:[
						'Folio',
	...
	*/
	...
	,	center: {
		...
		,	minWidth:				200
		,	minHeight:				200
		,	onresize_end:			function () { $("#gridExhortosPJJU").setGridWidth($("#mainContent").width() - 5, true); }
		}
	};
	
	/*
	*Funcion que abre el visor de exhortos
	*/
	function mostrarPantallaCapturaExhorto(rowID){
	...
	*/
	...
	function recargaGridAudienciasDelDia(){
		...
		jQuery("#gridExhortosPJJU").jqGrid('setGridParam', {url:'<%= request.getContextPath()%>/consultarAudienciaDelDiaPJENS.do',datatype: "xml" });
	...
	*/
	...
	function muestraAudiencias(){
		 $("#divgridExhortosPJJU").css("display","block");
	...
	function consultaGridControvercias(){
      ...
      $("#divgridExhortosPJJU").css("display","none");
	...
	<div id="mainContent">
		<div class="ui-layout-center">
			<div class="ui-layout-content">
				<div class="ui-layout-north">
					<div id="divgridExhortosPJJU">
						
						
			<table width="950" border="0" cellspacing="0" cellpadding="0">

			    <tr>
			        <td>&nbsp;</td>        <td colspan="5" rowspan="6">
			            <table id="gridExhortosPJJU" ></table> 
			    </tr>
