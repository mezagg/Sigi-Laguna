		...
		<table>
			<tbody>
				...
				<tr>
					...
					<td>
						<input id='rbtTestigoPersonaFisica' type="radio" name="rbtTestigoTipoPersona" value="0">Física <input id='rbtTestigoPersonaMoral' type="radio" name="rbtTestigoTipoPersona" value="1">Moral<br/>
				 	</td>
				</tr>
			</tbody>
		</table>
