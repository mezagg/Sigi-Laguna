		...
		<table>
			<tbody>
				...
				<tr>
					...
					<td>
						<input id='rbtVictimaPersonaFisica' type="radio" name="rbtVictimaTipoPersona" value="0">Física <input id='rbtVictimaPersonaMoral' type="radio" name="rbtVictimaTipoPersona" value="1">Moral<br/>
				 	</td>
				</tr>
			</tbody>
		</table>
