...
<link rel="stylesheet" type="text/css" media="screen" href="<%= request.getContextPath()%>/resources/css/jquery.windows-engine.css"/>
	...
	var elementoID=<%= request.getParameter("idEquipoTelefonico")%>;
	//Permite saber si la pantalla del objeto es nueva o proviene de una consulta(idElemento mayor a cero)
	var elementoIDOriginal=<%= request.getParameter("idEquipoTelefonico")%>;
	...
	jQuery().ready(			
		function () {
			...
			if(idEquipoTelefonico!=null && idEquipoTelefonico!=0)
			{
				...
				if(existeCadenaDeCustodiaPorIdObjeto(idEquipoTelefonico))
				{
					$("#anularElemento").hide("");
					
					//Se muestra el grid de Tipo de Estudio
	    			tipoObjetoId= '<%= Objetos.EQUIPO_TELEFONICO.getValorId() %>';
	    			$("#gridCatTipoEstudioTD").show("");
					consultarTipoEstudio(tipoObjetoId);
					
					if(existenEslabonesPorIdObjeto(idEquipoTelefonico)){
...
//	COMIENZA FUNCIONES PARA EL GUARDADO DE LOS DATOS		
	...
	*/
	function regresarControlCadenaCustodia(){
		if(elementoIDOriginal==0){
			...
			$("#btnGuardarEquipoTel").fadeOut(1000);
		}
  ...
  <body>
	<table width="600"  height="275" border="0" align="center" cellpadding="0" cellspacing="0">
		<tr><td>&nbsp;</td></tr>
		<tr height="12.5%">
			<td height="21" colspan="3" align="center">
				...
				<input type="button" id="btnGuardarEquipoTel" value="Guardar" class="ui-button ui-corner-all ui-widget" onclick="validaCamposObligatorios();" />
		...
		<tr height="12.5%">
			...
			<td width="32%" rowspan="6" align="center" valign="top">Descripci&oacute;n: 
