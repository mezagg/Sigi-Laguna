			...
			success: function(xml){
				var tipoExplosivo = $("#cbxTipoExplosivo option:selected").text();
				  ...
				  {	
					  ...
					  {
						  window.parent.customAlert('Se guardó correctamente la información', '',regresarControl(id,tipoExplosivo) );
					  }
				  }
				  ...
				  {   
					...
					//Desde asentarRegCadenaCustodiaView.jsp 
					  ...
					  {
						  window.parent.customAlert('La información se actualizó correctamente', '',regresarControl(id,tipoExplosivo) );
					  }
				  }
