				...
				success: function(xml){
					var tipoNumerario = $("#txtMonedaNumerario").val();
					  ...
					  {	
						  ...
						  {
							  window.parent.customAlert('Se guard&oacute; correctamente la informaci&oacute;n', '',regresarControl(id,tipoNumerario) );
						  }
					  }
					  ...
					  {   
						...
						//Desde asentarRegCadenaCustodiaView.jsp 
    					  ...
    					  {
    						  window.parent.customAlert('La informaci&oacute;n se actualiz&oacute; correctamente', '',regresarControl(id,tipoNumerario) );
    					  }
					  }
	...
	*/	
	...
	function validaCamposObligatorios(){
		...
		if(parseInt(condicionNumerario) == -1){
			mensaje += "<br />- Condici&oacute;n del numerario</li>";			
		}
				...
				<table width="573"  height="256" border="0" align="center" cellpadding="0" cellspacing="0">
					...
					<tr height="12.5%">
					    <td height="21" colspan="3" align="center">
					    	...
					    	<input type="button" id="btnGuardarNumerario" value="Guardar" onclick="validaCamposObligatorios();" class="ui-button ui-corner-all ui-widget" />
