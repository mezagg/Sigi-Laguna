	...
	*/	
	...
	function validaCamposObligatorios(){
		...
		if(parseInt(condicionVegetal) == -1){
			mensaje += "<br />- Condici&oacute;n del vegetal";			
		}
				 ...
				 <table width="590"  height="220px" border="0" align="center" cellpadding="0" cellspacing="0">
				     ...
				     <tr height="12.5%">
				         <td height="21" colspan="3" align="center">
				         	...
				         	<input type="button" id="btnGuardarVegetal" value="Guardar" onclick="validaCamposObligatorios();" class="ui-button ui-corner-all ui-widget" />
