...
<script type="text/javascript">
	...
	var solicitudId = <%=request.getParameter("solicitudId") != null ? request.getParameter("solicitudId") : "0"%>;
	...
	*/
	...
	function seleccionaActuacion(){
		...
		if(usaeditor == "true"){			
			...
			parametros += "&idSolicitudAnterior="+solicitudId;
			
			if (actividad == "<%=Actividades.REGISTRAR_ACUERDO_PROCEDIMIENTO_EJECUCION.getValorId()%>"){
