	...
	function cargaGridDocumentosDigitales(){
		...
		if(primeraVezGridDocumentosDigitales == true){
			jQuery("#gridDocumentosDigitales").jqGrid({
				...
				datatype: "xml", 
				colNames:['Área del responsable','Fecha de la actividad','Nombre de la actividad','Tipo de documento','Nombre de Documento','Fecha del documento','strEsGuardadoParcial','esGuardadoParcial','Tipo de documento'],
				...
				<div id="tabsconsultaprincipal-5">
					<table width="1000"  border="0" cellspacing="0" cellpadding="0">
			              <tr>
							...
							<td align="left">
								<input type="button" id="btnReenviarSolicitud" value="Enviar Solicitud" class="btn_Generico">
							</td>
			              </tr>
			            </table>
				</div>
