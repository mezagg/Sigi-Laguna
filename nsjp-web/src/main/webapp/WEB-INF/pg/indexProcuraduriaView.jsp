	...
	*/
	...
	$(document).ready(function() {
		...
		$("#divGridMedidasCautelares").hide();
			...
			datatype: "xml", 
                         multiselect:true,
			colNames:['Tipo','Descripci�n', 'Cantidad','N�mero Expediente','Fecha para enajenar','Fecha Aseguramiento'], 
            ...
            if (!rowKey)
	  		...
	  		async: false
                ...
                $.ajax(settings).done(function(result) 
                {
                  ...
                  $.newWindow({id:"iframewindowOficioEnajenacion", statusBar: true, posx:200,posy:50,width:114,height:40,title:"Oficio de enajenaci�n de bienes", type:"iframe", confirmarCierreVentana:false});
