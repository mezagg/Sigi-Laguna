...
<head>
        ...
        <title>Adjuntar documento a Audiencia</title>
		...
		function adjuntarArchivoActuaciones(){
				...
				document.adjuntarDocMandamientoForm.mandamientoJudicialId.value = idAudiencia;
...
<table width="436" border="0" summary="Tabla para registrar un amparo">
   ...
   <tr>
     <td align="center">
       ...
       <form id="adjuntarDocMandamientoForm" name="adjuntarDocMandamientoForm" action="<%= request.getContextPath() %>/adjuntarDocumentoAAudiencia.do" method="post" enctype="multipart/form-data" >
         * Archivo adjunto:
