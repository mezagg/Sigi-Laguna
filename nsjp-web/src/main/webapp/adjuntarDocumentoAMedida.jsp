...
<head>
        ...
        <script type="text/javascript">
         ...
         var medidaCautelarId='<%= request.getParameter("medidaCautelarId")%>';
		...
		function adjuntarArchivoActuaciones(){
				...
				document.adjuntarDocMandamientoForm.mandamientoJudicialId.value = medidaCautelarId;
...
<table width="436" border="0" summary="Tabla para registrar un amparo">
   ...
   <tr>
     <td align="center">
       ...
       <form id="adjuntarDocMandamientoForm" name="adjuntarDocMandamientoForm" action="<%= request.getContextPath() %>/adjuntarDocumentoAMedidaCautelar.do" method="post" enctype="multipart/form-data" >
         * Archivo adjunto:
