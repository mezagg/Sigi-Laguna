...
<div class="ui-layout-north">
	...
	<ul class="toolbar">
		<div id="menu_head">
			...
			<li id="tbarBtnNuevoExpediente" class="first"><span></span>Nuevo expediente</li>
			<li id="tbarBtnAbrirExpediente"><span></span>Abrir expediente</li>
			<li id="tbarBtnVincularExpedienteCaso"><span></span>Vincular expediente a caso</li>
			<li id="tbarBtnNuevo" class="first"><span></span>Nuevo Expediente</li>
			<li id="tbarBtnLectura"><span></span>Abrir Expediente</li>
...
<div id="divTurno">
<jsp:include page="/WEB-INF/paginas/vincularExpedienteCaso.jsp" />
</div>
