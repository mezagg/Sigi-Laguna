		...
		*/
		function cargaTodasLasSolicitudes(estado){
			...
			if(primeraConsulta == true){
				...
				jQuery("#gridSolsXAtndr").jqGrid('setGridParam', {url:'<%= request.getContextPath()%>/consultaSolsXAtnderUAVD.do?tipoSoliciutd='+idsTiposSolicitudes+'&idArea=0&estatus='+estadoSolicitud,datatype: "xml", page:1 });
	...
	*/
	function realizarValoracionHechos()
	{
	 ...
	 function registraDatosPersona(idrow) {
		 ...
		 */
		function consultarTiposSolicitudPorAreaDelFuncionario(idDivArbol,idArea,estatus)
		{
...
<div class="ui-layout-west">
	...
	<div class="content">
		<div id="accordionmenuprincipal">
			<h3 ><a href="#" id="cargaTodasSols" onclick="cargaTodasLasSolicitudes(<%=EstatusSolicitud.ABIERTA.getValorId()%>)" ><span >Solicitudes por atender</span></a></h3>
			<div>
