...
<script type="text/javascript" src="<%=request.getContextPath()%>/resources/js/timer/jquery.idletimer.js"></script>
	...
	$(document).ready(function() {
		...
		outerLayout = $("body").layout( layutSettings_Outer );
...
<div class="ui-layout-west">
	...
	<div class="content">
		<div id="accordionmenuprincipal">
			...
			<h3><a href="#">Gesti&oacute;n de <br>Almacenes de Expedientes</a></h3>
			<div>
				<ul id="seccion3tree" class="filetree">
							<li><span id="registro-almacen" class="file"><a id="registrarAlmacen" onclick="">Registrar Almac&eacute;n de Expedientes</a></span></li>
							<li><span id="modif-estado-almacen" class="file"><a id="cambiarEstado" onclick="">Cambiar estado de Almac&eacute;n de Expedientes</a></span></li>
							<li><span id="estado-almacen" class="file"><a id="modificarAlmacen" onclick="">Modificar Almac&eacute;n de Expedientes</a></span></li>
				</ul>
			</div>				
...
<!--			<div>-->
<!--					<center>-->
<!--						<a href="#" id="controlClima"><img	src="<%=request.getContextPath()%>/resources/images/img_clima.png"  width="201" height="178"></a>-->
<!--					</center>-->
<!--			</div>-->
	...
	<div class="content">
		<table width="100%" height="100%" border="0" cellspacing="0" cellpadding="0" background="<%=request.getContextPath()%>/resources/images/title/title13	.png">
			<tr>
	            ...
	            <td width="296" align="center" style="font-size:15px;"><span></span>Gesti&oacute;n de <br>Almacenes de Expedientes</td>
	            <td width="150" align="center"></td>
