...
<head>
	...
	$(document).ready(function() {
		...
		jQuery("#gridDetalleFrmPrincipal").jqGrid({ 
								...
								datatype: "xml", 
								colNames:['Caso','Fecha de Solicitud', 'Hora de Solicitud', 'Tipo de Audiencia','<bean:message key="probableResponsableTitulo"/>','Delito','Quien Solicita' ], 
								colModel:[ 	{name:'Caso',index:'Caso', width:20}, 
											{name:'Fecha',index:'fecha', width:30}, 
											{name:'Hora',index:'hora', width:30}, 
											{name:'Tipo',index:'tipo', width:30},
											{name:'Prob',index:'prob', width:30},
											{name:'Delito',index:'delito', width:20},
											{name:'Quien',index:'quien', width:30}
										],
								pager: jQuery('#pager1'),
								rowNum:10,
								rowList:[10,20,30],
		...
		<div id="accordionmenuprincipal">
			...
			<div>			
				<ul id="seccion1tree" class="filetree">
					<li class="closed"><span class="folder">2010</span>
						<ul>
							<li class="closed" id="Meses"><span class="folder">Enero</span>
								<ul>
									<li><span class="file"><a id="exp1">EXP DE UAVD</a></span></li>
									<li><span class="file"><a id="exp2">EXP 00000002</a></span></li>
								</ul>
							</li>
						</ul>
						<ul>
							<li class="closed" id="Meses"><span class="folder">Ferbrero</span>
								<ul>
									<li><span class="file"><a id="exp3">EXP 00000003</a></span></li>
									<li><span class="file"><a id="exp4">EXP 00000004</a></span></li>
								</ul>
							</li>
						</ul>
												<ul>
							<li class="closed" id="Meses"><span class="folder">Marzo</span>
								<ul>
								</ul>
							</li>
						</ul>
			...
			<h3><a href="#">Seguimiento a solicitudes</a></h3>
			<div>
			...
			<h3><a href="#">Consultar docs. de expediente</a></h3>
			<div>
...
<!--			<li id="buscarCaso" ><span></span>Buscar Caso</li>-->
				<li id="EnviarNotif" ><span></span>Enviar Notificaciones</li>
				<li id="Ayuda" ><span></span>Ayuda</li>
		</div>
		<div id="menu_config">
		
			<li id="generarDocumento"><a href="#">Generar Documento</li>
			<li><a href="#">Imprimir</a></li>
			<li><a href="#">Guardar</a></li>
			<li><a href="#">Digitalizar Documentos</a></li>
...
<div id="mainContent">
	<div class="ui-layout-center">
		<div class="ui-layout-content">
			<textarea rows="15" cols="147">DETALLE DE SOLICITUD</textarea>
		</div>
	</div>
	<div class="ui-layout-north">
