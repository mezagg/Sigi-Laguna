...
<div class="ui-layout-west">
	...
	<div class="content">
		<div id="accordionmenuprincipal">
			...
			<h3><a href="#" id="hrefIndexProcuraduriaView">Unidad de investigaci&oacute;n</a></h3>
			<div>
				&nbsp;
			</div>
			...
			<h3><a href="#" id="hrefIndexProcuraduriaEnviarNotificaciones">Atenci&oacute;n a V&iacute;ctimas del Delito
			</a></h3>
			<div>
				&nbsp;
			</div>
...
<!--			-->
<!--			<h3><a href="#" id="hrefAdminAsigAbogadoDef">Administraci&oacute;n Abogado Defensor</a></h3>-->
<!--			<div>-->
<!--				&nbsp;-->
<!--			</div>-->
			
<!--			-->
<!--			<h3><a href="#" id="hrefDesignarAbogDefensor">Designar Abogado Defensor</a></h3>-->
<!--			<div>-->
<!--				&nbsp;-->
<!--			</div>-->
<!--			-->
<!--			<h3><a href="#" id="hrefIndexDefensoriaAtencionTemprana">Defensoria Atenci&oacute;n Temprana</a></h3>-->
<!--			<div>-->
<!--				&nbsp;-->
<!--			</div>-->
