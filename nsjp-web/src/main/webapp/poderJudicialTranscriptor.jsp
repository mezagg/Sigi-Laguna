...
<script type="text/javascript" src="<%=request.getContextPath()%>/resources/js/jquery.zweatherfeed.js"></script>
	...
	$(document).ready(function() {
		...
		cargaGridSolicitudesDeTranscripcion('delDia')
		...
		*/
		...
		//Variable para realizar la recarga del grid, desde el visor, al finalizar la transcripcion
		var estatusGrid="";
		
		function cargaGridSolicitudesDeTranscripcion(estatusSolicitado){
		...
		*/
		function dblClickRowBandejaAudiencias(solicitudId,solicitante){
	    	...
	    	$.updateWindowContent("iframewindowAtenderSolicitudTranscripcionAudiencia"+idWindowVisorTranscriptor,'<iframe src="<%=request.getContextPath()%>/transcriptorSolicitudes.do?solicitudId='+solicitudId+'&solicitante='+solicitante+'&estatusGrid='+estatusGrid+'&idWindowVisorTranscriptor='+idWindowVisorTranscriptor+'" width="900" height="250" />'); 
		}

		
		/*
		*Funcion que cierra la ventana del detalle de las solicitudes
		*/
		function cerrarVentanaSolicitud(numId){
			pantalla ="iframewindowAtenderSolicitudTranscripcionAudiencia"+numId;
		...
		<div id="accordionmenuprincipal">
			...
			<div>			
				 <ul id="seccion0tree" class="filetree">
				 	<li class="closed" ><span class="file" onclick="cargaGridSolicitudesDeTranscripcion('delDia');">Del D&iacute;a</span></li>
					<li class="closed" ><span class="file" onclick="cargaGridSolicitudesDeTranscripcion('enProceso');">Por Atender</span></li>
