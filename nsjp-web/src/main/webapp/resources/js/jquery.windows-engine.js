...
jQuery.extend({
    ...
    newWindow: function(options) {
        ...
        var move = function($obj, x, y) {
            ...
            x = (x + w/3) < width  ? x : (width  - w/3);
            y = (y + h/3) < height ? y : (height - h/3);
        ...
        $windowStatusBar.bind('mousedown', function(e) {
        	  ...
        	  $obj = $(e.target).parent().parent();
              $obj.find(".window-titleBar-content").click();
    ...
    activarAvisoAlCerrarVentana: function(idFrame, bandera) {
    	try{
    		$("#" + idFrame).data('esMensajeActivado', bandera);
    	}catch(e){};
    }
});