	...
	<!-- 	<h3><a href="#" onclick="activaSecundario()"><img src="<%=request.getContextPath() %>/resources/images/icn_carpprincipal.png" id="botpenal" width="15" height="15">&nbsp;Expedientes Remitidos</a></h3>
			<div>
				<ul id="seccion11tree" class="filetree">
					<li class="closed" ><span id="casos_unidad_inv" class="folder" onclick="activaDos()">Por Unidad de Investigación</span>
						<ul>
						
						</ul>
					</li>
					<li class="closed" ><span id="casos_at_penal" class="folder" onclick="activaDos()">Por Atención Temprana Penal</span>
						<ul>
			...
			<!-- <h3><a href="#" onclick="activaDos()"><img src="<%=request.getContextPath() %>/resources/images/icn_carpprincipal.png" id="botpenal" width="15" height="15">&nbsp;Expedientes del Área</a></h3>
			<div>
				AMP: 
