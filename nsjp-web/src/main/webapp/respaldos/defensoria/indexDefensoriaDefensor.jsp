	...
	$(document).ready(function() {
		...
		*/
		...
		function defensaIntegracion() {
		    ...
		    $.updateWindowContent("iframewindowVisorDefensor",'<iframe src="<%= request.getContextPath() %>/visorExpedienteDefensoria.do?idNumeroExpediente='+numExpediente+'&numeroCaso='+numeroCaso+'" width="1140" height="400" />');
