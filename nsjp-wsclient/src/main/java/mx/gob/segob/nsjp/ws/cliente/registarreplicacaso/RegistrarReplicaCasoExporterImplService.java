 ...
 * 2013-08-16T13:45:50.024-05:00
 * Generated source version: 2.4.2
 * 
 */
@WebServiceClient(name = "RegistrarReplicaCasoExporterImplService", 
                  wsdlLocation = "http://localhost:49801/nsjp-web/RegistrarReplicaCasoExporterImplService?wsdl",
...
public class RegistrarReplicaCasoExporterImplService extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("http://localhost:49801/nsjp-web/RegistrarReplicaCasoExporterImplService?wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(RegistrarReplicaCasoExporterImplService.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "http://localhost:49801/nsjp-web/RegistrarReplicaCasoExporterImplService?wsdl");
        }
        WSDL_LOCATION = url;
    }
