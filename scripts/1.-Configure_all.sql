...
update Parametro 
set cValor='http://localhost:8080/imagenes/imagen'
...
,'http://localhost:8080/imagenes/') AS NText) where  CAST(cCuerpo as NVarchar(MAX)) like '%172.25.48.8%';
...
,'http://localhost:8080/imagenes/') AS NText) where  CAST(cCuerpo as NVarchar(MAX)) like '%10.10.30.11%';

--Para cambiar al password Pa55w0rd
select * from Usuario
