...
select * from JerarquiaOrganizacional where JerarquiaOrganizacional_id = 44
...
values
  ...
  select * from ConfActividadDocumento where TipoActividad_val
  
select * from Valor where CampoCatalogo_id=69 order by valor_id desc
